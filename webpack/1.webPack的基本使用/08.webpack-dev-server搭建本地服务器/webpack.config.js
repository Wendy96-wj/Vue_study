...
module.exports = {
    ...
    plugins:[
        ...
        new UglifyWebpackPlugin() // npm install uglifyjs-webpack-plugin@1.1.1 --save-dev
    ],
    devServer:{
...
// 服务器运行：webpack-dev-server (./node_modules/.bin/webpack-dev-server)
// 在package.json里配置 "dev":"webpack-dev-server"
// npm run dev

// webpack分离  
// npm install webpack-merge --save-dev  合并
